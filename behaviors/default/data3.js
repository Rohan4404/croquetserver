...
class LightPawn extends PawnBehavior {
  setup() {
    ...
    let model, params, temperatureInterval;
    ...
    const onDocumentMouseClick = async (event) => {
      // console.log(this.C, "viewid is sdwdwd wwdwd ");
    ...
    setInterval(fetchHighlightedObjectName, 1000);
    ...
    loadModelPromise
      .then((model) => {
        ...
        if (!window.gui) {
          ...
          params = {
            temperatureThreshold: 25, // Default temperature threshold
