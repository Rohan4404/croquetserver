...
class LightPawn extends PawnBehavior {
  setup() {
    ...
    const sun = new THREE.DirectionalLight(0x0000ff, 0.4);
    ...
    const blueLight = new THREE.DirectionalLight(0x444488, 0.8);
    blueLight.position.set(1, 100, 150);
    group.add(blueLight);
    this.lights.push(blueLight);

    const redLight = new THREE.DirectionalLight(0x774444, 0.8);
